...
public class Customer {
    ...
    List<Product> productOwner = new ArrayList<>();
    @OneToMany(mappedBy = "productBuyer", cascade = CascadeType.ALL, fetch = FetchType.LAZY, orphanRemoval = true)
    List<Product> productBuyer = new ArrayList<>();
    @Id
